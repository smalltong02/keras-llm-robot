from WebUI.Server.db.models.knowledge_base_model import KnowledgeBaseModel
from WebUI.Server.db.models.knowledge_file_model import KnowledgeFileModel, FileDocModel
