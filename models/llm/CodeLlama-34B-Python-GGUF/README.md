...
```shell
huggingface-cli download TheBloke/CodeLlama-34B-Python-GGUF --local-dir . --local-dir-use-symlinks False --include='*Q4_K*gguf'
```
...
```shell
HUGGINGFACE_HUB_ENABLE_HF_TRANSFER=1 huggingface-cli download TheBloke/CodeLlama-34B-Python-GGUF codellama-34b-python.q4_K_M.gguf --local-dir . --local-dir-use-symlinks False
```
